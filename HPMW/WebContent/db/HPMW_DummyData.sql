...
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('2222', '2222');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('3333', '3333');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('4444', '4444');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('5555', '5555');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('6666', '6666');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('7777', '7777');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('8888', '8888');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('9999', '9999');
INSERT INTO PARTTIMER(PTID, PTPW) VALUES('4567', '4567');
...
INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO)
    VALUES(TRIM(TO_CHAR(PTCONT_SEQ.NEXTVAL, '00000009')), '4567', '홍길동', '010-1111-1111', 'HONG@NAVER.COM', '서울시 강남구 압구정', 300, '55444466668888');
INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO)
    VALUES(TRIM(TO_CHAR(PTCONT_SEQ.NEXTVAL, '00000009')), '1234', '장준길', '010-6568-4567', 'JANG@NAVER.COM', '충남 기산면', 200, '11112222555544');
    
    
INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO)
    VALUES(TRIM(TO_CHAR(PTCONT_SEQ.NEXTVAL, '00000009')), '1654', '서수화', '010-5546-1654', 'SAE@NAVER.COM', '남양주 다산동', 100, '55556666555544');

INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO, 
                              EVNO, PTSTATUS, PTWORKTIME, PTHOURLYWAGE, PTTOTALPAY)
    VALUES(TRIM(TO_CHAR(PTCONT_SEQ.NEXTVAL, '00000009')), '5849', '양효재', '010-5546-5849', 'YANG@NAVER.COM', '부산시 남구', 100, '55556666555544',
           null, 0, null, null, null);

INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO, 
                              EVNO, PTSTATUS, PTWORKTIME, PTHOURLYWAGE, PTTOTALPAY)
    VALUES(TRIM(TO_CHAR(PTCONT_SEQ.NEXTVAL, '00000009')), '8795', '송지승', '010-5546-8795', 'SONG@NAVER.COM', '인천', 200, '55556666555577',
           null, 0, NULL, NULL, NULL);
select * from parttimer; 
SELECT * FROM PARTTIMERCONTRACT;
update PARTTIMERCONTRACT set ptrdate = '22/07/11' where ptstatus = 0;
commit;
