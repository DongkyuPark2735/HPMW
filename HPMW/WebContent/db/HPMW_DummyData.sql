...
=======
    VALUES(TO_CHAR(PTCONT_SEQ.NEXTVAL, '0000009'), '0586', '홍길동', '010-1111-1111', 'HONG@NAVER.COM', '서울시 강남구 압구정', 300, '55444466668888');
INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO)
    VALUES(TO_CHAR(PTCONT_SEQ.NEXTVAL, '0000009'), '1234', '장준길', '010-6568-4567', 'JANG@NAVER.COM', '충남 기산면', 200, '11112222555544');
INSERT INTO PARTTIMERCONTRACT(PTCONNO, PTID, PTNAME, PTTEL, PTEMAIL, PTADDRESS, BTNO, PTACCOUNTNO)
    VALUES(TO_CHAR(PTCONT_SEQ.NEXTVAL, '0000009'), '5894', '서수화', '010-5546-8521', 'SAE@NAVER.COM', '남양주 다산동', 100, '55556666555544');
>>>>>>> ab135680e289d5c252352cc9bf3e3ad4612310eb
