...
CREATE TABLE PARTTIMERCONTRACT(
    ...
    PTTOTALPAY NUMBER(6),
    PTRDATE DATE DEFAULT TO_DATE(SYSDATE, 'YY/MM/DD')
);
...
-- 파트타이머 근로계약서 저장 테이블
DROP TABLE PASTPARTTIMERCONTRACTDATA;

CREATE TABLE PASTPARTTIMERCONTRACTDATA(
    PCDATANO VARCHAR2(8) PRIMARY KEY,
    PTCONNO VARCHAR2(8) NOT NULL,
    PTID VARCHAR2(5) NOT NULL,
    PTNAME VARCHAR2(15) NOT NULL,
    PTTEL VARCHAR2(13) NOT NULL,
    PTEMAIL VARCHAR2(50),
    PTADDRESS VARCHAR2(150),
    BTNO NUMBER(3) NOT NULL,
    PTACCOUNTNO VARCHAR2(14) NOT NULL,
    EVNO VARCHAR2(9),
    PTSTATUS NUMBER(1) NOT NULL, 
    PTWORKTIME NUMBER(3),
    PTHOURLYWAGE NUMBER(5),
    PTTOTALPAY NUMBER(6),
    PTRDATE VARCHAR2(15)
